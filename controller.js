...
const paymentCallback = async (req, res) => {
  try {
    ...
    const callbackMetadata = callbackData.Body?.stkCallback || callbackData.Body?.stkCallback?.CallbackMetadata;
    const checkoutRequestID = callbackData.Body?.stkCallback?.CheckoutRequestID || null;
